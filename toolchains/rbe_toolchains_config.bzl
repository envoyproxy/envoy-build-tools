...
_ENVOY_BUILD_IMAGE_TAG = "55d9e4719d2bd0accce8f829b44dab70cd42112a"

_ENVOY_BUILD_IMAGE_REPOSITORY_LINUX = "envoy-ci/envoy-build"
_ENVOY_BUILD_IMAGE_DIGEST_LINUX = "sha256:ec5aff53dad8363ad579dcbf139ca2b832a5aedb78581cbedaa994818f98b552"
_CONFIGS_OUTPUT_BASE_LINUX = "toolchains/configs/linux"

_ENVOY_BUILD_IMAGE_REPOSITORY_WINDOWS = "envoy-ci/envoy-build-windows"
_ENVOY_BUILD_IMAGE_DIGEST_WINDOWS = "sha256:dc3b9e657634a65beecb4b6b31a8e245ae53fdfd2fc5c19f8018fc7486697171"
...
def rbe_toolchains_config(generator = False, force = False):
    linux_exec_properties = create_rbe_exec_properties_dict(docker_add_capabilities = "SYS_PTRACE,NET_RAW,NET_ADMIN", docker_network = "standard", docker_ulimits="memlock=-1,nice=-20,rtprio=10,stack=8192")
